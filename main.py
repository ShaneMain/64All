...
def create_build_option_widgets(repo_options):
    row = 6  # Starting row for build options
...
ttk.Label(main_frame, text="Repository URL:").grid(row=0, column=0, padx=5, pady=3, sticky=tk.E)
repo_url_combobox = ttk.Combobox(main_frame, values=repo_names, width=47)
repo_url_combobox.grid(row=0, column=1, padx=5, pady=3, sticky=tk.W)
repo_url_combobox.current(0)
repo_url_combobox.bind("<<ComboboxSelected>>", on_repo_selection)

ttk.Label(main_frame, text="Base Directory:").grid(row=1, column=0, padx=5, pady=3, sticky=tk.E)
clone_dir_entry = ttk.Entry(main_frame, width=50)
clone_dir_entry.grid(row=1, column=1, padx=5, pady=3, sticky=tk.W)
browse_button = ttk.Button(main_frame, text="Browse...", command=browse_directory)
browse_button.grid(row=1, column=2, padx=5, pady=3, sticky=tk.W)
...
ttk.Label(main_frame, text="Branch:").grid(row=2, column=0, padx=5, pady=3, sticky=tk.E)
branch_var = tk.StringVar()
branch_menu = ttk.OptionMenu(main_frame, branch_var, "")
branch_menu.config(width=45)
branch_menu.grid(row=2, column=1, padx=5, pady=3, sticky=tk.W, columnspan=2)
...
clone_button.grid(row=3, column=0, columnspan=3, padx=5, pady=8, sticky=tk.W + tk.E)
...
output_text.grid(row=5, column=0, columnspan=3, padx=5, pady=5, sticky=tk.W + tk.E)
